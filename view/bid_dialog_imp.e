...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_vertical_box_1.extend (player_selector)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_1)
			l_ev_horizontal_box_1.extend (price)
			...
			text.set_text ("Choose the player who will buy the property and the price")
			price.set_text ("10000")
			price.value_range.adapt (create {INTEGER_INTERVAL}.make (1, 10000))
			price.set_value (10000)
			l_ev_label_1.set_text ("CHF")
			ok_button.set_text ("Buy")
...
feature -- Access
	...
	text: EV_LABEL
	player_selector: EV_COMBO_BOX
	price: EV_SPIN_BUTTON
