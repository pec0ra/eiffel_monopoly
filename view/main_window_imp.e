...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_menu_bar_1.extend (menu_box)
			menu_box.extend (new_game_menu)
			menu_box.extend (end_game_menu)
			menu_box.extend (about_menu)
			extend (box)
			box.extend (l_ev_horizontal_box_1)
			l_ev_horizontal_box_1.extend (board_pixmap)
			l_ev_horizontal_box_1.extend (player_info_box)
			box.extend (console)

			menu_box.set_text ("Menu")
			new_game_menu.set_text ("New_game")
			end_game_menu.set_text ("End game")
			about_menu.set_text ("About")
			box.set_minimum_width (1000)
			l_ev_horizontal_box_1.set_minimum_width (1000)
			board_pixmap.set_minimum_width (Board_width)
			board_pixmap.set_minimum_height (Board_width)
			board_pixmap.set_with_named_file (Image_path + "board.png")
			player_info_box.set_minimum_width (400)
			console.set_text ("Output :")
			console.set_minimum_width (465)
			console.set_minimum_height (200)
	...
	frozen create_interface_objects
		...
		do
			...
			create menu_box
			create new_game_menu
			create end_game_menu
			create about_menu
			create box
			create l_ev_horizontal_box_1
			create board_pixmap
			create player_info_box
			create console
...
feature -- Access
	...
	menu_box: EV_MENU
	new_game_menu, end_game_menu, about_menu: EV_MENU_ITEM
	box, player_info_box: EV_VERTICAL_BOX
	board_pixmap: EV_PIXMAP
	console: EV_TEXT
