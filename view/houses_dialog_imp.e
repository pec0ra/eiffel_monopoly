...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_vertical_box_1.extend (property_selector)
			l_ev_vertical_box_1.extend (buy_sell_box)
			buy_sell_box.extend (buy_button)
			buy_sell_box.extend (sell_button)
			l_ev_vertical_box_1.extend (house_number)
			l_ev_vertical_box_1.extend (price_info)
			...
			text.set_text ("Buy or sell houses")
			buy_button.set_text ("Buy")
			sell_button.set_text ("Sell")
			house_number.set_text ("1")
			house_number.value_range.adapt (create {INTEGER_INTERVAL}.make (1, 3))
			house_number.set_value (1)
			ok_button.set_text ("Ok")
			ok_button.set_minimum_width (75)
...
feature -- Access
	...
	text, price_info: EV_LABEL
	property_selector: EV_COMBO_BOX
	buy_sell_box, button_box: EV_HORIZONTAL_BOX
	buy_button, sell_button: EV_RADIO_BUTTON
	house_number: EV_SPIN_BUTTON
	ok_button,
